...
-- -----------------------------------------------------
-- Table `pizza_projeto`.`tb_pessoa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_pessoa` (
...
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_cliente` (
  ...
  INDEX `fk_tb_cliente_tb_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
  CONSTRAINT `fk_tb_cliente_tb_pessoa1`
    FOREIGN KEY (`id_pessoa`)
    REFERENCES `pizza_projeto`.`tb_pessoa` (`id_pessoa`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_endereco` (
  ...
  INDEX `fk_tb_endereco_tb_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_pedido` (
  ...
  INDEX `fk_tb_pedido_tb_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tb_pedido_tb_pessoa1`
    FOREIGN KEY (`id_pessoa`)
    REFERENCES `pizza_projeto`.`tb_pessoa` (`id_pessoa`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_funcionario` (
  ...
  INDEX `fk_tb_funcionario_tb_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `pizza_projeto`.`tb_telefone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_telefone` (
  `idt_telefone` INT(11) NOT NULL AUTO_INCREMENT,
  `ds_telefone` VARCHAR(45) NOT NULL,
  `tel_classificador` VARCHAR(45) NOT NULL,
  `id_pessoa` INT(11) NOT NULL,
  PRIMARY KEY (`idt_telefone`),
  INDEX `fk_tb_telefone_tb_pessoa1_idx` (`id_pessoa` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `pizza_projeto`.`tb_grupo_permissao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_grupo_permissao` (
...
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_usuario` (
  ...
  PRIMARY KEY (`us_id`),
  INDEX `fk_tb_usuario_tb_pessoa_idx` (`id_pessoa` ASC) VISIBLE,
  INDEX `fk_tb_usuario_tb_grupo_permissao1_idx` (`id_grupo_permissao` ASC) VISIBLE,
  CONSTRAINT `fk_tb_usuario_tb_pessoa`
    FOREIGN KEY (`id_pessoa`)
    REFERENCES `pizza_projeto`.`tb_pessoa` (`id_pessoa`),
  CONSTRAINT `fk_tb_usuario_tb_grupo_permissao1`
    FOREIGN KEY (`id_grupo_permissao`)
    REFERENCES `pizza_projeto`.`tb_grupo_permissao` (`id_grupo_permissao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `pizza_projeto`.`tb_permissao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pizza_projeto`.`tb_permissao` (
  `id_permissao` INT NOT NULL AUTO_INCREMENT,
  `permissao` VARCHAR(45) NOT NULL,
  `id_grupo_permissao` INT NOT NULL,
  PRIMARY KEY (`id_permissao`),
  INDEX `fk_tb_permissao_tb_grupo_permissao1_idx` (`id_grupo_permissao` ASC) VISIBLE,
  CONSTRAINT `fk_tb_permissao_tb_grupo_permissao1`
    FOREIGN KEY (`id_grupo_permissao`)
    REFERENCES `pizza_projeto`.`tb_grupo_permissao` (`id_grupo_permissao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
